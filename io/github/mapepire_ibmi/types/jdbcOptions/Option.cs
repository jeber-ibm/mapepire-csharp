...
public static readonly String NAMING = "naming";
     ...
     */
public static readonly String DATE_FORMAT = "date format";
     ...
     */
public static readonly String DATE_SEPARATOR = "date separator";

    /**
     * Specifies the decimal separator used in numeric literals within SQL
     * statements.
     */
public static readonly String DECIMAL_SEPARATOR = "decimal separator";

    /**
     * Specifies the time format used in time literals within SQL statements.
     */
public static readonly String TIME_FORMAT = "time format";
     ...
     * "hms".
     */
public static readonly String TIME_SEPARATOR = "time separator";
     ...
     * monitors are active.
     */
public static readonly String FULL_OPEN = "full open";
...
public static readonly String ACCESS = "access";
     ...
     */
public static readonly String AUTOCOMMIT_EXCEPTION = "autocommit exception";

    /**
     * Specifies the output string type of bidirectional data.
     */
public static readonly String BIDI_STRING_TYPE = "bidi string type";

    /**
     * Specifies if bidi implicit LTR-RTL reordering should be used.
     */
public static readonly String BIDI_IMPLICIT_REORDERING = "bidi implicit reordering";

    /**
     * Specifies if the numeric ordering round trip feature should be used.
     */
public static readonly String BIDI_NUMERIC_ORDERING = "bidi numeric ordering";
     ...
     */
public static readonly String DATA_TRUNCATION = "data truncation";
...
public static readonly String ERRORS = "errors";
     ...
     */
public static readonly String EXTENDED_METADATA = "extended metadata";
     ...
     */
public static readonly String HOLD_INPUT_LOCATORS = "hold input locators";
     ...
     */
public static readonly String HOLD_STATEMENTS = "hold statements";
     ...
     * procedures.
     */
public static readonly String IGNORE_WARNINGS = "ignore warnings";
...
public static readonly String KEEP_ALIVE = "keep alive";
     ...
     */
public static readonly String KEY_RING_NAME = "key ring name";
     ...
     */
public static readonly String KEY_RING_PASSWORD = "key ring password";
     ...
     * procedures.
     */
public static readonly String METADATA_SOURCE = "metadata source";
     ...
     */
public static readonly String PROXY_SERVER = "proxy server";
...
public static readonly String REMARKS = "remarks";
     ...
     */
public static readonly String SECONDARY_URL = "secondary URL";
...
public static readonly String SECURE = "secure";
     ...
     */
public static readonly String SERVER_TRACE = "server trace";

    /**
     * Specifies whether threads are used in communication with the host servers.
     */
public static readonly String THREAD_USED = "thread used";
     ...
     */
public static readonly String TOOLBOX_TRACE = "toolbox trace";
...
public static readonly String TRACE = "trace";
     ...
     * fields.
     */
public static readonly String TRANSLATE_BINARY = "translate binary";
     ...
     */
public static readonly String TRANSLATE_BOOLEAN = "translate boolean";
...
public static readonly String LIBRARIES = "libraries";
     ...
     */
public static readonly String AUTO_COMMIT = "auto commit";
     ...
     */
public static readonly String CONCURRENT_ACCESS_RESOLUTION = "concurrent access resolution";
     ...
     * work are released.
     */
public static readonly String CURSOR_HOLD = "cursor hold";
     ...
     * ignored.
     */
public static readonly String CURSOR_SENSITIVITY = "cursor sensitivity";
...
public static readonly String DATABASE_NAME = "database name";
     ...
     * earlier.
     */
public static readonly String DECFLOAT_ROUNDING_MODE = "decfloat rounding mode";

    /**
     * Specifies the maximum decimal precision the database might use.
     */
public static readonly String MAXIMUM_PRECISION = "maximum precision";

    /**
     * Specifies the maximum scale the database might use.
     */
public static readonly String MAXIMUM_SCALE = "maximum scale";

    /**
     * Specifies the minimum scale value for the result of decimal division.
     */
public static readonly String MINIMUM_DIVIDE_SCALE = "minimum divide scale";

    /**
     * Specifies the character encoding to use for the SQL package and any
     * statements sent to the server.
     */
public static readonly String PACKAGE_CCSID = "package ccsid";

    /**
     * Specifies the default transaction isolation.
     */
public static readonly String TRANSACTION_ISOLATION = "transaction isolation";

    /**
     * Specifies how hexadecimal literals are interpreted.
     */
public static readonly String TRANSLATE_HEX = "translate hex";
     ...
     */
public static readonly String TRUE_AUTOCOMMIT = "true autocommit";

    /**
     * Specifies whether lock sharing is allowed for loosely coupled transaction
     * branches.
     */
public static readonly String XA_LOOSELY_COUPLED_SUPPORT = "XA loosely coupled support";
     ...
     */
public static readonly String BIG_DECIMAL = "big decimal";
     ...
     * the current row.
     */
public static readonly String BLOCK_CRITERIA = "block criteria";
     ...
     */
public static readonly String BLOCK_SIZE = "block size";
     ...
     */
public static readonly String DATA_COMPRESSION = "data compression";
     ...
     */
public static readonly String EXTENDED_DYNAMIC = "extended dynamic";
     ...
     */
public static readonly String LAZY_CLOSE = "lazy close";
     ...
     */
public static readonly String LOB_THRESHOLD = "lob threshold";
     ...
     */
public static readonly String MAXIMUM_BLOCKED_INPUT_ROWS = "maximum blocked input rows";
...
public static readonly String PACKAGE = "package";
     ...
     */
public static readonly String PACKAGE_ADD = "package add";
     ...
     * "extended dynamic" property is set to "true".
     */
public static readonly String PACKAGE_CACHE = "package cache";
     ...
     * "true".
     */
public static readonly String PACKAGE_CRITERIA = "package criteria";
...
public static readonly String PREFETCH = "prefetch";
     ...
     */
public static readonly String QAQQINILIB = "qaqqinilib";
     ...
     */
public static readonly String QUERY_OPTIMIZE_GOAL = "query optimize goal";

    /**
     * Specifies the mechanism to implement the queryTimeout feature.
     */
public static readonly String QUERY_TIMEOUT_MECHANISM = "query timeout mechanism";
     ...
     * to execute.
     */
public static readonly String QUERY_STORAGE_LIMIT = "query storage limit";

    /**
     * Specifies the buffer size used to receive data through the socket connection
     * between the front-end driver and the system.
     */
public static readonly String RECEIVE_BUFFER_SIZE = "receive buffer size";

    /**
     * Specifies the buffer size used to send data through the socket connection
     * between the front-end driver and the system.
     */
public static readonly String SEND_BUFFER_SIZE = "send buffer size";

    /**
     * Specifies whether variable-length fields should be compressed.
     */
public static readonly String VARIABLE_FIELD_COMPRESSION = "variable field compression";
...
public static readonly String SORT = "sort";
     ...
     */
public static readonly String SORT_LANGUAGE = "sort language";
     ...
     * "table".
     */
public static readonly String SORT_TABLE = "sort table";
     ...
     */
public static readonly String SORT_WEIGHT = "sort weight";
    ...
    /**
     * Get the  JDBC option representation of a string.
     * 
